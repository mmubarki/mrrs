...
public class ClinicController implements Serializable {
    ...
    @EJB
    private mrrs.logic.ejb.ClinicFacade ejbFacade;
    ...
    public Clinic getClinic(java.lang.Integer id) {
