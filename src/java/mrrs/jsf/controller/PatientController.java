...
import mrrs.logic.ejb.PatientFacade;
...
public class PatientController implements Serializable {
    ...
    @EJB
    private mrrs.logic.ejb.PatientFacade ejbFacade;
    ...
    public String prepareView() {
        System.out.println("inside prepareView");
    ...
    void setSelected(Patient patient) {
        current =   patient;
    }
